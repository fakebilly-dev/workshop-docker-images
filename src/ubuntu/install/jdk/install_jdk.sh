...
wget -qO /usr/local/jdk/jdk-8u202-linux-x64.tar.gz 'https://www.dropbox.com/scl/fi/rfmvdctx7pkgv6i7r58fa/jdk-8u202-linux-x64.tar.gz?rlkey=9kx6r55pcbki6e6yenpdz5yd8&raw=1'
tar -zxf /usr/local/jdk/jdk-8u202-linux-x64.tar.gz -C /usr/local/jdk/
...
rm -rf /usr/local/jdk/jdk-17.0.8.tar.gz /usr/local/jdk/jdk-8u202-linux-x64.tar.gz